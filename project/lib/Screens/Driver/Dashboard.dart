    ...
    _voiceController = VoiceAssistantController(
      onNavigate: (screen) async {
        ...
        if (screen == 'passengers') setState(() { _selectedIndex = 0; });
          ...
          _loadAssistantSetting();
        } else if (screen == 'poll') Navigator.push(context, MaterialPageRoute(builder: (_) => const PollScreen()));
        else if (screen == 'attendance_history') Navigator.push(context, MaterialPageRoute(builder: (_) => const AttendanceHistoryScreen()));
        else if (screen == 'payment_history') Navigator.push(context, MaterialPageRoute(builder: (_) => const PaymentHistoryScreen()));
        else if (screen == 'cash_history') Navigator.push(context, MaterialPageRoute(builder: (_) => const CashHistoryScreen()));
        else if (screen == 'register_passenger') Navigator.push(context, MaterialPageRoute(builder: (_) => const NewPassengerScreen()));
        else if (screen == 'today_passengers') Navigator.push(context, MaterialPageRoute(builder: (_) => const TodaypassengersScreen()));
